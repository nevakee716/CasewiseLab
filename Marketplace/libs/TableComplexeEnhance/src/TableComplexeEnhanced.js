...
(function(cwApi, $) {
  ...
  var TableComplexeEnhancedConfig = {
    ...
    clearButtonName : 'Enlever Tous les Filtres',
    popOut: true,
    ...
    risque_1233042236_ofhaoiefhapoihjfap : {
   	  heightPercent : 1, 
      column : {
        1 : {order : 3, name : "Risque"},
        2 : {order : 4},
        3 : {order : 5},
        4 : {order : 6},
        5 : {order : 7},                        
    ...
    analyse_du_risque_20215_229842855_aiogheoa : {
      heightPercent : 2,
    },
    analyse_du_risque_20217_494729071_fhaoipfh : {
      heightPercent : 2,
    }
  };
